...
<div class="container">
    ...
    <main id="analysis">
        <article>
            <h1>GOT IT!<br>WE ANALAYZED YOUR PLAYLIST</h1>
            <h3>You have a great taste by the way...</h3>
            <input id="addbands" type="text" placeholder="Manually add for more artists ( 5 max )">
            <span id="add">+</span>
        </article>
        <article id="artists">
        </article>
